...
def standardize_channel_name(name):
    ...
    name = name.replace("CCTV1_综合", "CCTV1")
    name = name.replace("CCTV2_财经", "CCTV2")
    name = name.replace("CCTV3_综艺", "CCTV3")
    name = name.replace("CCTV4_国际", "CCTV4")
    name = name.replace("CCTV4_中文国际", "CCTV4")
    name = name.replace("CCTV4_欧洲", "CCTV4")
    name = name.replace("CCTV5_体育", "CCTV5")
    name = name.replace("CCTV6_电影", "CCTV6")
    name = name.replace("CCTV7_军事", "CCTV7")
    name = name.replace("CCTV7_军农", "CCTV7")
    name = name.replace("CCTV7_农业", "CCTV7")
    name = name.replace("CCTV7_国防军事", "CCTV7")
    name = name.replace("CCTV8_电视剧", "CCTV8")
    name = name.replace("CCTV9_记录", "CCTV9")
    name = name.replace("CCTV9_纪录", "CCTV9")
    name = name.replace("CCTV10_科教", "CCTV10")
    name = name.replace("CCTV11_戏曲", "CCTV11")
    name = name.replace("CCTV12_社会与法", "CCTV12")
    name = name.replace("CCTV13_新闻", "CCTV13")
    name = name.replace("CCTV_新闻", "CCTV13")
    name = name.replace("CCTV14_少儿", "CCTV14")
    name = name.replace("CCTV15_音乐", "CCTV15")
    name = name.replace("CCTV16_奥林匹克", "CCTV16")
    name = name.replace("CCTV17_农业农村", "CCTV17")
    name = name.replace("CCTV17_农业", "CCTV17")
    name = name.replace("CCTV4K_超", "CCTV4K")
    name = name.replace("CCTV4K超", "CCTV4K")
    name = name.replace("CCTV5+_体育赛视", "CCTV5+")
    name = name.replace("CCTV5+_体育赛事", "CCTV5+")
    name = name.replace("CCTV5+_体育", "CCTV5+")
